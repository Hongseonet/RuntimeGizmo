...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
		...
		public Transform mainTargetRoot 
		{
			get 
			{
				return (targetRootsOrdered.Count > 0) ? (useFirstSelectedAsMain) ? targetRootsOrdered[0] : targetRootsOrdered[targetRootsOrdered.Count - 1] : null;
			}
		}
        ...
        void OnEndCameraRendering(ScriptableRenderContext context, Camera camera) //instead of OnPostRender : not working on URP HDRP
        {
